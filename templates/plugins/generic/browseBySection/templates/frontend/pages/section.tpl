		...
		<div class="col-lg-8">
			<div class="page-content">
				...
				{else}
					...
					{if $prevPage > 1}
						{capture assign="prevUrl"}{url|escape router=\PKP\core\PKPApplication::ROUTE_PAGE page="section" op="view" path=$sectionPath|to_array:$prevPage}{/capture}
					{elseif $prevPage === 1}
						{capture assign="prevUrl"}{url|escape router=\PKP\core\PKPApplication::ROUTE_PAGE page="section" op="view" path=$sectionPath}{/capture}
					{/if}
					{if $nextPage}
						{capture assign="nextUrl"}{url|escape router=\PKP\core\PKPApplication::ROUTE_PAGE page="section" op="view" path=$sectionPath|to_array:$nextPage}{/capture}
					{/if}
					{include
